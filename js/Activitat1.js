...
// DIFICULTADES
let francia = document.getElementById("fr");
let polonia = document.getElementById("po");
let ucrania = document.getElementById("uc");
let irak = document.getElementById("ik");
// USERNAME
let username = document.getElementById("username");
let errorN = document.getElementById("error_name");
let errorD = document.getElementById("error_difi");
errorN.style.display = "none";
errorD.style.display = "none";
// TEXTOS
let p_dificultad = document.getElementById("add_diff");
let p_aciertos = document.getElementById("aciertos");
let p_fallos = document.getElementById("fallos");
let p_tiempo_win = document.getElementById("add_time_win");
let p_tiempo_lose = document.getElementById("add_time_lose");
let p_nintents = document.getElementById("n_intents");
// Section win
let p_text_win = document.getElementById("add_text_win");
let p_username_win = document.getElementById("add_username_win");
let p_dificultad_win = document.getElementById("add_diff_win");
let p_temps_win = document.getElementById("add_time_win");
let p_aciertos_win = document.getElementById("add_aciertos_win");
let p_fallos_win = document.getElementById("add_fallos_win");
// Section lose
let p_text_lose = document.getElementById("add_text_lose");
let p_username_lose = document.getElementById("add_username_lose");
let p_dificultad_lose = document.getElementById("add_diff_lose");
let p_temps_lose = document.getElementById("add_time_lose");
let p_aciertos_lose = document.getElementById("add_aciertos_lose");
let p_fallos_lose = document.getElementById("add_fallos_lose");
// Section datos
let p_datos = document.getElementById("datos");
// SECTIONS
let s_dificultad = document.getElementById("dificultad");
let s_jugar = document.getElementById("juego");
let s_win = document.getElementById("win");
let s_lose = document.getElementById("lose");
let s_consulta = document.getElementById("consulta");
...
function seleccionar_dificultad(a) {
    if (a == 8) {
        resetDificultad();
